  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      ...
      <main style={{ backgroundColor: 'white' }}>
        ...
        <Container sx={{ py: 8}} maxWidth="lg" className='portifolio'>
              ...
              <Grid item key={repo.name} xs={12} sm={6} md={4}>
                ...
                >
                  <CardMedia
                    ...
                    image={repoImages[repo.name] || 'DEFAULT_IMAGE_URL'} // Use a default image URL if one is not found in the mapping
                  />
