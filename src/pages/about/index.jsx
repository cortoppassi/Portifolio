          ...
          <Typography variant="h5" align="left" color="#1b263b" paragraph>
            ...
            <ul>
              <li>
                ...
                soluções de IA para atender a diversas necessidades
                empresariais, com ênfase na entrega de qualidade e otimização de
                custos.
              </li>
              <li>
              ...
              <li>
                Gerenciamento de instâncias EC2 em ambientes de nuvem, com foco
                em escalabilidade e segurança.
              </li>
              <li>
              ...
              <li>
                Experiência em integração de APIs, otimização de desempenho web
                e implementação de novas funcionalidades para projetos de grande
                porte.
              </li>
            </ul>
          </Typography>
